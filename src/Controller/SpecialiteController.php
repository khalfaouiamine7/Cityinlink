...
class SpecialiteController extends AbstractController
{
    ...
    public function index(Request $request, SpecialiteRepository $specialiteRepository): Response
    {
        ...
        if ($searchTerm) {
            $specialite = $specialiteRepository->findByNom($searchTerm);
        } else {
    ...
    public function sort(Request $request, SpecialiteRepository $specialiteRepository): Response
    {
        $criteria = $request->query->get('criteria', 'nom');
        $direction = $request->query->get('direction', 'asc');
    
        $specialites = $specialiteRepository->findBy([], [$criteria => $direction]);
