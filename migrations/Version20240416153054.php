 ...
 */
final class Version20240416153054 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE consultaion CHANGE specialite specialite INT NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE consultaion CHANGE specialite specialite INT DEFAULT NULL');
